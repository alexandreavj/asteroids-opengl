...
inline void loadMaterial(int material) {
	...
	GLfloat  emeraldAmb[] = { 0.0215 ,0.1745 ,0.0215, 1. };
	GLfloat  emeraldDif[] = { 0.07568 ,0.61424 ,0.07568, 1. };
	GLfloat  emeraldSpec[] = { 0.633 ,0.727811 ,0.633, 1. };
	GLint    emeraldCoef = 0.6 * 128;
    ...
    GLfloat  orangePlasticAmb[] = { 0.2 ,0.1 ,0.0, 1. };
    GLfloat  orangePlasticDif[] = { 0.5 ,0.25 ,0.0, 1. };
    GLfloat  orangePlasticSpec[] = { 0.60 ,0.60 ,0.00, 1. };
    GLint    orangePlasticCoef = 0.25 * 128;
    
    GLfloat rockyAmb[] = { 0.2 ,0.2 ,0.2, 1. };
    GLfloat rockyDif[] = { 0.6 ,0.6 ,0.6, 1. };
    GLfloat rockySpec[] = { 0.2 ,0.2 ,0.2, 1. };
    GLint   rockyCoef = 0.1 * 128;
    
    GLfloat shinyAmb[] = { 1. ,1. ,1. , 1. };
    GLfloat shinyDif[] = { 0. ,0. ,0., 1. };
    GLfloat shinySpec[] = { 0. ,0. ,0., 1. };
    GLint   shinyCoef = 1. * 128;
    
    GLfloat pureWhiteAmb[] = { 1. ,1. ,1. , 1. };
    GLfloat pureWhiteDif[] = { 1. ,1. ,1., 1. };
    GLfloat pureWhiteSpec[] = { 1. ,1. ,1., 1. };
    GLint   pureWhiteCoef = 1. * 128;
	...
	switch (material) {
        ...
        case 18: // yellowPlastic
            glMaterialfv(GL_FRONT, GL_AMBIENT, orangePlasticAmb);
            glMaterialfv(GL_FRONT, GL_DIFFUSE, orangePlasticDif);
            glMaterialfv(GL_FRONT, GL_SPECULAR, orangePlasticSpec);
            glMaterialf(GL_FRONT, GL_SHININESS, orangePlasticCoef);
            break;
        case 19: // rocky
            glMaterialfv(GL_FRONT, GL_AMBIENT, rockyAmb);
            glMaterialfv(GL_FRONT, GL_DIFFUSE, rockyDif);
            glMaterialfv(GL_FRONT, GL_SPECULAR, rockySpec);
            glMaterialf(GL_FRONT, GL_SHININESS, rockyCoef);
            break;
        case 20: // shiny
            glMaterialfv(GL_FRONT, GL_AMBIENT, shinyAmb);
            glMaterialfv(GL_FRONT, GL_DIFFUSE, shinyDif);
            glMaterialfv(GL_FRONT, GL_SPECULAR, shinySpec);
            glMaterialf(GL_FRONT, GL_SHININESS, shinyCoef);
            break;
        case 21: // pureWhite
            glMaterialfv(GL_FRONT, GL_AMBIENT, pureWhiteAmb);
            glMaterialfv(GL_FRONT, GL_DIFFUSE, pureWhiteDif);
            glMaterialfv(GL_FRONT, GL_SPECULAR, pureWhiteSpec);
            glMaterialf(GL_FRONT, GL_SHININESS, pureWhiteCoef);
            break;
